...
[![GoDoc](https://godoc.org/github.com/dballard/bine?status.svg)](https://godoc.org/github.com/dballard/bine)
...
See info below, the [API docs](http://godoc.org/github.com/dballard/bine), and the [examples](examples). The project is
...
statically in the binary, follow the [embedded package docs](https://godoc.org/github.com/dballard/bine/process/embedded)
which will require [building Tor statically](https://github.com/dballard/tor-static). Then with
`github.com/dballard/bine/process/embedded` imported, change the start line above to:
